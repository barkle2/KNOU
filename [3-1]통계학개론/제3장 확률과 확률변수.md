...
<img src="https://latex.codecogs.com/svg.latex?P(A\cub\,\!B)" />  
<img src="https://latex.codecogs.com/svg.latex?P(A\cub\,\!B)=P(A)+P(B)-P(A\cap\,\!B)" />  
만일 <img src="https://latex.codecogs.com/svg.latex?A\cub\,\!B)=\varnothing" />이면 <img src="https://latex.codecogs.com/svg.latex?P(A\cub\,\!B)=P(A)+P(B)" />이고, 사건 A, B를 서로 배반사건(mutually exclusive events)이라고 한다.
